...
long insertArray (Tarray *A, long pair); // inserts pair in A, returns pos

void deleteArray (Tarray *A); // deletes last cell in A

Tarray createArray (float factor, long minsize); // creates empty array
