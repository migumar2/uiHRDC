...
#define DATA_TYPES_IL_INCLUDED
	...
	typedef struct {	
		...
		uint *clen;		    //len of each compressed list (in integers);
		ulong padUints;  // number of uints added as padding info for qmx-to-work  (will be substracted from "final size").
