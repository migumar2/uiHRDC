...
###
	...
	do
		...
		./SEARCH indexes/wiki20gb E  1 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1_1000
...
###
	...
	do
		...
		./sampleK indexes/wiki20gb $i
		./SEARCH indexes/wiki20gb E  500 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1001_100k
		./appendLastLine E.dat sampleK=$i
	done
