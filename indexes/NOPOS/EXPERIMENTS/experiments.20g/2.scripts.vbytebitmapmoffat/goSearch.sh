...
./SEARCH indexes/wiki20gb_bitmap8_k4  E 200 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g.words.f1_1000
./SEARCH indexes/wiki20gb_bitmap8_k32 E 200 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g.words.f1_1000
mv E.dat E_Wa.2.vbyte.moffat.dat

./SEARCH indexes/wiki20gb_bitmap8_k4  E 200 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g.words.f1001_100k
./SEARCH indexes/wiki20gb_bitmap8_k32 E 200 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g.words.f1001_100k
mv E.dat E_Wb.2.vbyte.moffat.dat

./SEARCH indexes/wiki20gb_bitmap8_k4  N 5 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g_2_2
./SEARCH indexes/wiki20gb_bitmap8_k32 N 5 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g_2_2
mv N.dat N_p2.2.vbyte.moffat.dat

./SEARCH indexes/wiki20gb_bitmap8_k4  N 5 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g_5_5
./SEARCH indexes/wiki20gb_bitmap8_k32 N 5 "int2=svs;intn=svs;fsearch=expM" < ../../patterns/wiki20g_5_5
