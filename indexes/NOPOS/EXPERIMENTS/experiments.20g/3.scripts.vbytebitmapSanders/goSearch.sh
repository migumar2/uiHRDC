...
./SEARCH indexes/wiki20gb_bitmap1_k16  E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1_1000
#./SEARCH indexes/wiki20gb_bitmap1_k64  E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1_1000
./SEARCH indexes/wiki20gb_bitmap1_k128 E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1_1000
mv E.dat E_Wa.3.vbyte.sanders.dat

./SEARCH indexes/wiki20gb_bitmap1_k16  E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1001_100k
#./SEARCH indexes/wiki20gb_bitmap1_k64  E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1001_100k
./SEARCH indexes/wiki20gb_bitmap1_k128 E 200 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1001_100k
mv E.dat E_Wb.3.vbyte.sanders.dat

./SEARCH indexes/wiki20gb_bitmap1_k16  N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_2_2
#./SEARCH indexes/wiki20gb_bitmap1_k64  N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_2_2
./SEARCH indexes/wiki20gb_bitmap1_k128 N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_2_2
mv N.dat N_p2.3.vbyte.sanders.dat

./SEARCH indexes/wiki20gb_bitmap1_k16  N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_5_5
#./SEARCH indexes/wiki20gb_bitmap1_k64  N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_5_5
./SEARCH indexes/wiki20gb_bitmap1_k128 N   5 "int2=lookup;intn=lookup" < ../../patterns/wiki20g_5_5
