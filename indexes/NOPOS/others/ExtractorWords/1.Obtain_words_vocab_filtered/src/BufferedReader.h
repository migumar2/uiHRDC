...
#define BUFFER_SIZE (1024L*1024L*1024L*24L)
...
typedef struct sBuffer
  { long size;		/* size of this buffer */
    ...
    long fpos;		/* pos of current buffer in file */
    byte *data;		/* current text */
    long dsize;		/* size of current text */
    long minDataInBuffer;
  } *BufferRead;
