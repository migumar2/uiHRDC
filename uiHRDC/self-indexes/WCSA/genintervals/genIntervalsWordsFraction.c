...
main (int argc, char **argv)
   ...
   { int n,m,J,t,frac;
     ...
     if (argc < 5)
	{ fprintf (stderr,
"\nUsage: %s <intsfile> <fraction [2,4,6...]> <number> <intervals file>\n\n"
"  randomly extracts <number> intervals of length <length> from <intsfile>.\n"
"  randomly extracts, from <file>, <number> intervals of integers whose length\n"
"  is (sizeof<intsfile> / <fraction>) uints.\n"
"  The output file, <intervals file> has a first line of the form:\n"
"    # number=<number> length=<width> file=<intsfile>\n"
"  and then <number> lines of the form <from>,<to>.\n\n",argv[0]
	...
	{ fprintf (stderr,"Error: cannot stat file %s\n",argv[1]);
     ...
     n = sdata.st_size/sizeof(unsigned int);
     
     fprintf(stderr,"\n max value to be generated is %i\n",n);
	...
	frac=m; //the fraction of the size of the text
	m=n/m;  //the width of the interval.
	fprintf(stderr,"\n The interval-width was set to %u, fraction is= %u\n",m, frac);
	...
	{ fprintf (stderr,"Error: cannot open file %s for writing\n",argv[4]);
     ...
     if (fprintf (ofile,"# number=%lu numwords=%i file=%s\n", J,m,argv[1]) <= 0)
