...
###
	...
	do
		...
		./SEARCH indexes/wiki20gb E  5000 "int2=skip;intn=skip" < ../../patterns/wiki20g.words.f1_1000
...
###
	...
	do
		...
		./sampleK indexes/wiki20gb $i
		./SEARCH indexes/wiki20gb E  1000 "int2=skip;intn=skip" < ../../patterns/wiki20g.words.f1001_100k
		./appendLastLine E.dat sampleK=$i
	done
...
###
	...
	do
		...
		./sampleK indexes/wiki20gb $i
		./SEARCH indexes/wiki20gb N   50 "int2=skipE;intn=skipE" < ../../patterns/wiki20g_2_2
...
###
	...
	do
		...
		./sampleK indexes/wiki20gb $i
		./SEARCH indexes/wiki20gb N   50 "int2=skipE;intn=skipE" < ../../patterns/wiki20g_5_5
		./appendLastLine N.dat sampleK=$i
	done
