...
./SEARCH indexes/wiki20gb E  2000 "int2=merge;intn=merge" < ../../patterns/wiki20g.words.f1_1000
mv E.dat E_Wa.4.2.repair.dat

./SEARCH indexes/wiki20gb E  300 "int2=merge;intn=merge" < ../../patterns/wiki20g.words.f1001_100k
mv E.dat E_Wb.4.2.repair.dat

./SEARCH indexes/wiki20gb N   20 "int2=merge;intn=merge" < ../../patterns/wiki20g_2_2
mv N.dat N_p2.4.2.repair.dat

./SEARCH indexes/wiki20gb N   20 "int2=merge;intn=merge" < ../../patterns/wiki20g_5_5
