...
./SEARCH indexes/wiki20gb E 5000 "int2=mergeS9;intn=mergeS9" < ../../patterns/wiki20g.words.f1_1000
mv E.dat E_Wa.7.simple9.dat

./SEARCH indexes/wiki20gb E 5000 "int2=mergeS9;intn=mergeS9" < ../../patterns/wiki20g.words.f1001_100k
mv E.dat E_Wb.7.simple9.dat

./SEARCH indexes/wiki20gb N 100 "int2=mergeS9;intn=mergeS9" < ../../patterns/wiki20g_2_2
mv N.dat N_p2.7.simple9.dat

./SEARCH indexes/wiki20gb N 100 "int2=mergeS9;intn=mergeS9" < ../../patterns/wiki20g_5_5
