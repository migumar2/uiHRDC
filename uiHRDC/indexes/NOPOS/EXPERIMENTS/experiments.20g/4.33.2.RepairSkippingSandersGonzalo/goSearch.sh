...
###
	...
	do
		...
		./SEARCH indexes/wiki20gb E  5000 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1_1000
		./appendLastLine E.dat sampleK=$i
	done
	mv  E.dat  E_Wa.4.3.2repairG.skipping.sanders.dat 
...
###
	...
	do
		...
		./sampleK indexes/wiki20gb $i
		./SEARCH indexes/wiki20gb E  1000 "int2=lookup;intn=lookup" < ../../patterns/wiki20g.words.f1001_100k
		./appendLastLine E.dat sampleK=$i
	done
	mv  E.dat E_Wb.4.3.2repairG.skipping.sanders.dat
...
#./SEARCH indexes/torsen2000mb E 1 "int2=lookup;intn=lookup" < ../patterns/torsen2000mb_1_1_10k
#./SEARCH indexes/torsen2000mb I 1 "int2=lookup;intn=lookup" < ../patterns/torsen2000mb_2_2_10k
#./SEARCH indexes/torsen2000mb N 1 "int2=lookup;intn=lookup" < ../patterns/torsen2000mb_2_5_10k
#echo "################################################################"
