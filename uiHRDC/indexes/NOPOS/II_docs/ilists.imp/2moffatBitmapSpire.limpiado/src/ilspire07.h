 ...
 * 
 * ilspire07.h: Implementation of the functions in the interfaz in "interface.h".
 *   
...
int fsearchBinMem (void *ail, uint id, uint value); 
int fsearchExp (void *ail, uint id, uint value);
int fsearchExpMem (void *ail, uint id, uint value);



	/* INTERSECT_2 algorithms */
int svs2   (void *ail, uint id1, uint id2, uint *noccs, uint **occs);
int svs2f  (void *ail, uint id1, uint id2, uint *noccs, uint **occs);
