...
/***************************************************************************************/
/******************************* DEALING WITH SIZE_T pointers   ************************/
/******************************* Fari. 2013. Non portable code  ************************/
/***************************************************************************************/



	/** uints required to represent n integers of e bits each */
	inline uint uint_len_LL(const uint e, const size_t n) {
	 ...
	 * @param index Position to be retrieved
	 */
	inline uint get_field_LL(const uint *A, const size_t len, const size_t index) {
		if(len==0) return 0;
	 ...
	 * @param x Value to be stored
	 */
	inline void set_field_LL(uint *A, const size_t len, const size_t index, const uint x) {
		if(len==0) return;
