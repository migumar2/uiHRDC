...
uint* intersect_aux_simd(uint* arr1, uint len1, uint* arr2, uint len2, uint* len);int merge_N_SIMD (void *ail, uint *ids, uint nids, uint *noccs, uint **occs);
