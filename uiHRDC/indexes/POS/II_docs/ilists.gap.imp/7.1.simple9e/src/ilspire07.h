...
/******************************************************************/
	...
	/* extracts a list, adding GAP to all the postings */
int extractList_gap_il (void *ail, uint id, int **list, uint *len, int GAP);
...
//int s9_DecompressionAndIntersect(unsigned int* input, unsigned int* output, int size, uint *ptri,uint *ptrend, uint *matches) ;
