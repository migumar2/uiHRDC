...
RePairDocCompressor::build_representation(unsigned char *text, unsigned int length, unsigned int *docBeginnings, unsigned int numdocs, uint sampling)
{
	...
	cout << "SAMPLING-CT-REPAIR = "<<sampling;
...
{
	*size = docs->getSize() + dictionary->getSize() + sequence->getSize() + samplepos->size() + sizeof(RePairDocCompressor);	

	cout << "\n++++++++++++++++++++++++++" << endl;
	cout << "Doc boundaries: " << docs->getSize() <<  " bytes." <<endl;
	cout << "Rules dictionary: " << dictionary->getSize() << " bytes." <<endl;
	cout << "Sequence: " << sequence->getSize() << " bytes." <<endl;
	cout << "Samples: " << samplepos->size() << " bytes." <<endl;
	cout << "Sizeof: " << sizeof(RePairDocCompressor) << " bytes." <<endl;
