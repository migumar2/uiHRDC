...
cd 2.1.scripts.vbyte.TestExtract           ; sh clean.sh ; rm -f posting*; rm -f *.dat; rm -f ?-LOG.dat*; rm -f indexes/*; rm -f *.txt; cd ..
...
cd 4.33.scripts.Repair.skipping.Gonzalo    ; sh clean.sh ; rm -f posting*; rm -f *.dat; rm -f ?-LOG.dat*; rm -f indexes/*; rm -f *.txt; cd ..
...
cd 4.33.1.scripts.RepairSkipping.Moffat    ; sh clean.sh ; rm -f posting*; rm -f *.dat; rm -f ?-LOG.dat*; rm -f indexes/*; rm -f *.txt; cd ..
...
cd 4.33.2.scripts.RepairSkipping.Sanders   ; sh clean.sh ; rm -f posting*; rm -f *.dat; rm -f ?-LOG.dat*; rm -f indexes/*; rm -f *.txt; cd ..
...
cd 7.1.scripts.simple9e                    ; sh clean.sh ; rm -f posting*; rm -f *.dat; rm -f ?-LOG.dat*; rm -f indexes/*; rm -f *.txt; cd ..
