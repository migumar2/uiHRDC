...
./SEARCH indexes/wiki2gb E  100 "int2=merge;intn=merge" < ../../patterns/wiki2g.words.f1_1000
mv E.dat E_Wa.6.vbyte.lzma.dat

./SEARCH indexes/wiki2gb E  100 "int2=merge;intn=merge" < ../../patterns/wiki2g.words.f1001_100k
