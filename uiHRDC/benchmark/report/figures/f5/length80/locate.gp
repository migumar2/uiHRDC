...
set output "extract80.eps"
set title "Extract of Snippets (80 chars)" font "Bitstream-Vera-Sans,24"
...
plot\
  ...
  "e.Words20_swcsa.dat" using (100*$1/2087767849):($4) title "WCSA" with linespoints ls 14 lc rgb 'black'
