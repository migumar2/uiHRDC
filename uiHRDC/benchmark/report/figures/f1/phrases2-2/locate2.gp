...
plot\
  ...
  "N_p2.2.vbyte.moffat.dat" using (100*$1/26597454863):3 title "Vbyte-CM" 			with linespoints ls 4 lc rgb 'red',\
  ...
  "N_p2.2.vbyte.moffat.bitmap8.dat" using (100*$1/26597454863):3 title "Vbyte-CMB" 	with linespoints ls 8,\
...
## "N_p2.4.2.repairG.dat" using (100*$1/20971541599):3 title "RePair" 				with linespoints lt 3 pt 11,\
## "N_p2.4.3.repairG.skipping.dat" using (100*$1/20971541599):3 title "RePair-Skip"	with linespoints lt 3 pt 9
##
###  "N_p2.4.2.repair.dat" using (100*$1/20971541599):3 title "RePairAprox" with linespoints ls 10,\
###  "N_p2.4.3.repair.skipping.dat" using (100*$1/20971541599):3 title "RePairAprox-Skip" with linespoints ls 8,\
