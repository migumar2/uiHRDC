...
class static_bitsequence_builder_brw32 : public static_bitsequence_builder {
  public:
    ...
    static_bitsequence_builder_brw32(unsigned int sampling);
    ~static_bitsequence_builder_brw32() {}
    static_bitsequence * build(unsigned int * bitsequence, unsigned int len);
