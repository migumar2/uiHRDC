...
namespace cds_static
{
	...
	{	
		public:
			...
			uint labelsPerColumn(uint column, Rule *labels, uint lenright, uint offset);
			uint labelsPerRow(uint row, Rule *labels, uint lenright, uint offset);
			...
			uint labelsInRange(uint a1, uint a2, uint b1, uint b2, Rule *labels);
			uint labelsInRangeNoBitSeq(uint a1, uint a2, uint b1, uint b2, Rule *labels);
		...
		protected:
			...
			uint Range(uint i1, uint i2, uint j1, uint j2, uint t1, uint t2, int left, int right, uint h, Rule *labels);
	};
};
