...
main (int argc, char **argv)
   ...
   { int n,m,J,t,frac;
     ...
     if (argc < 5)
	{ fprintf (stderr,
"\nUsage: %s <file> <fraction [2,4,6...]> <number> <intervals file>\n\n"
"  randomly extracts, from <file>, <number> intervals whose length is (sizeof<file> / <fraction>) chars.\n"
"  The output file, <intervals file> has a first line of the form:\n"
"    # number=<number> length=<width> file=<file>\n"
"  and then <number> lines of the form <from>,<to>.\n\n",argv[0]
	...
	{ fprintf (stderr,"Error: cannot stat file %s\n",argv[1]);
     ...
     m = atoi(argv[2]);
     if ((m <= 0) || (m > n))
	{ fprintf (stderr,"Error: <fraction> must be >= 1 and <= file length"
			  " (%i)\n",n);
	  exit(1);
	}
